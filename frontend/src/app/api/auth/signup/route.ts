...
export async function POST(req: NextRequest) {
  ...
  // If Supabase returned a session immediately (email confirmation
  // disabled on this project), log the user in right away. If
  // email_confirmation_required is true, there's no token yet — the
  // frontend shows a "check your email" message instead.
